  ...
  return (
    <header
      ...
      className={cn(
        ...
        isScrolled
          ? "bg-gray-950/90 backdrop-blur-md py-3 shadow-lg shadow-purple-500/10"
          : "bg-transparent py-6"
      )}
    >
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          >
            <div className="relative w-20 h-20 rounded-full overflow-hidden border-2 border-purple-500 transform transition-all duration-300 group-hover:scale-110 group-hover:border-cyan-400 group-hover:shadow-lg group-hover:shadow-purple-500/20">
              <img
            ...
            <span className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-cyan-500 transition-all duration-300 group-hover:from-cyan-400 group-hover:to-purple-500">
              VS
            </span>
          </a>
          ...
          {isMobile ? (
            ...
            <nav className="flex items-center gap-8 relative">
              ...
              <a
                href="https://drive.google.com/file/d/1Gq40hqc5-u33MRzaMQ0EjsOwPk7Ssa6b/view?usp=drive_link"
                rel="noopener noreferrer"
                className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-white rounded-md text-sm font-medium shadow-md shadow-purple-500/20 hover:shadow-purple-500/40 transition-all duration-300"
              >
                Resume
              </a>
            </nav>
